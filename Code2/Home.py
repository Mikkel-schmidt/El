...
if check_password():
    ...
    col2.metric('Forbrug i 2022', '{:.2f} kWh'.format(data[data['year']==2022]['amount'].sum()) )
    col3.metric('Forbrug i sidste måned', '{:.2f} kWh'.format(data[(data['year']==2022) & (data['month'] == 'Februar')]['amount'].sum()))
